...
const CheckStatusPage = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (inputIdx.trim()) {
      // Passes the email/ID directly to the Status Dashboard
    ...
    <div style={styles.container}>
      ...
      >
        ...
        <p style={styles.subtitle}>
          Enter your registered ALX email address to view all your active <span style={{color: colors.secondary.electricBlue, fontWeight: 'bold'}}>Creative Tech</span> pairings and queue requests.
        </p>
