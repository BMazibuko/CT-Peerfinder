...
const VolunteerMarketplace = () => {
  ...
  // If someone lands here without going through the landing page, send them back to the portal
  useEffect(() => {
    if (!program || !course) {
  ...
  return (
    <div style={styles.container}>
      <nav style={styles.navbar}>
        <div style={styles.navLeft} onClick={() => window.location.href = PORTAL_URL}>
          <span style={styles.logoText}>&larr; Back to Portal</span>
        </div>
      </nav>
      ...
      <div style={styles.header}>
        ...
        <p style={{margin: 0, color: '#ccc', fontSize: '1.1rem'}}>
          Program: <strong>{program === 'GD' ? 'Graphic Design' : program === 'CC' ? 'Content Creation' : program}</strong> | Short Course: <strong>{course}</strong>
        </p>
      ...
      <div style={styles.content}>
        {loading ? (
          <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '50px'}}>
            <Spinner size="50px" color={CT_RED} />
            <p style={{marginTop: '15px', color: '#ccc'}}>Scanning the network for available Creative Tech volunteers...</p>
          </div>
                  ...
                  <div style={styles.cardHeader}>
                    ...
                    <div style={{flex: 1, overflow: 'hidden'}}>
                      ...
                      <div style={{marginTop: '5px'}}>
                        <span style={{fontSize: '0.85rem', background: '#ffebee', color: '#c62828', padding: '2px 8px', borderRadius: '10px', fontWeight: 'bold'}}>
                  ...
                  <div style={styles.capacitySection}>
                    ...
                    <div style={styles.progressBarBg}>
                      <motion.div 
                        ...
                        style={{...styles.progressBarFill, background: `linear-gradient(90deg, #ff8a80, ${CT_RED})`}} 
                      />
                    </div>
                  </div>
...
const styles = {
  ...
  navLeft: { cursor: 'pointer', display: 'inline-block' },
  logoText: { color: CT_RED, fontWeight: '700', fontSize: '1rem' },
  ...
  pairBtn: { width: '100%', padding: '15px', background: CT_RED, color: 'white', border: 'none', borderRadius: '30px', fontWeight: 'bold', fontSize: '1rem', marginTop: 'auto', cursor: 'pointer', transition: 'transform 0.2s', boxShadow: '0 4px 10px rgba(243, 44, 44, 0.2)' },
  ...
  fallbackBtn: { padding: '15px 30px', background: CT_RED, color: 'white', border: 'none', borderRadius: '30px', fontWeight: 'bold', fontSize: '1rem', cursor: 'pointer', boxShadow: '0 4px 10px rgba(243, 44, 44, 0.3)' },
