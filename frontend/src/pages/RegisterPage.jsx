...
const RegisterPage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    volunteer_capacity: '', 
    pseudonym: '', // Replaces gender for 'offer'
  ...
  return (
    <div style={styles.container}>
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} style={styles.card}>
        <h2 style={styles.header}>Register for {program === 'GD' ? 'Graphic Design' : program === 'CC' ? 'Content Creation' : program}</h2>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
           ...
           {/* Pseudonym Field replaces Gender ONLY for Volunteers offering support */}
           {connectionType === 'offer' && (
               <div style={{marginBottom: '15px'}}>
                 ...
                 <input 
                    ...
                    placeholder="e.g., Creative Helper, Design Star" 
                    required 
                 />
           ...
           {connectionType === 'offer' && (
              <div style={{background: '#fef2f2', padding: '15px', borderRadius: '8px', border: `1px solid ${CT_RED}`}}>
                <label style={{...styles.label, color: '#991b1b'}}>Volunteer Capacity (How many peers can you support?) *</label>
                ...
                <p style={{fontSize: '0.8rem', color: '#b91c1c', marginTop: '5px'}}>
           ...
           <div style={styles.checkboxContainer}>
                <input type="checkbox" name="disclaimer_agree" onChange={handleChange} required style={{accentColor: CT_RED}}/>
                <label style={{marginLeft:'10px', fontSize: '0.9rem', color: '#555'}}>
                    I accept the <Link to="/disclaimer" target="_blank" style={{color: CT_RED, textDecoration: 'underline', fontWeight: 'bold'}}>Disclaimer</Link>.
                </label>
           </div>
...
const styles = {
  ...
  backBtn: { alignSelf: 'flex-start', marginBottom: '20px', background: 'transparent', border: `1px solid ${CT_RED}`, color: CT_RED, padding: '8px 16px', borderRadius: '20px', cursor: 'pointer', fontWeight: 'bold' },
  ...
  input: { width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid #ddd', fontSize: '1rem', boxSizing: 'border-box', outlineColor: CT_RED },
  select: { width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid #ddd', fontSize: '1rem', backgroundColor: 'white', boxSizing: 'border-box', outlineColor: CT_RED },
  ...
  submitButton: { padding: '15px', marginTop: '20px', background: `linear-gradient(45deg, #f32c2c, #ff6b6b)`, border: 'none', borderRadius: '30px', color: 'white', fontWeight: 'bold', fontSize: '1.1rem', cursor: 'pointer', boxShadow: '0 4px 15px rgba(243, 44, 44, 0.3)' },
